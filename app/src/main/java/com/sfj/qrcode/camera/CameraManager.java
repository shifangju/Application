...
import com.sfj.qrcode.camera.open.OpenCameraInterface;
...
public final class CameraManager {
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int width = Math.min(findDesiredDimensionInRange(screenResolution.x, MIN_FRAME_WIDTH, MAX_FRAME_WIDTH),
